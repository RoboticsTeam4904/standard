...
/**
 * A limit switch that extends the generic button class.
 *
 */
public class CustomDigitalLimitSwitch extends Button implements CustomButton {
	...
	/**
	 * Returns true when the limit switch is pressed. This is based on the raw value
	 * of the limit switch, not only once when it is first pressed.
	 */
	@Override
	public boolean get() {
