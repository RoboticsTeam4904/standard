...
/**
 * Encoders that can calculate netDisplacement
 */
public class DisplacementEncoders extends EncoderPair implements Subsystem {
    ...
    public DisplacementEncoders(CustomEncoder leftEncoder, CustomEncoder rightEncoder, double distanceTolerance,
    ...
    public DisplacementEncoders(CustomEncoder leftEncoder, CustomEncoder rightEncoder, double robotWidth) {
