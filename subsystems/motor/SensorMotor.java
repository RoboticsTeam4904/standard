...
public abstract class SensorMotor extends Motor {
	...
	public SensorMotor(String name, boolean isInverted, MotionController motionController, CustomSpeedController... motors) {
		this(name, isInverted, new IdentityModifier(), motionController, motors);
	}

	public SensorMotor(String name, SpeedModifier speedModifier, MotionController motionController, CustomSpeedController... motors) {
		this(name, false, speedModifier, motionController, motors);
	}

	public SensorMotor(String name, MotionController motionController, CustomSpeedController... motors) {
	...
	public SensorMotor(boolean isInverted, MotionController motionController, CustomSpeedController... motors) {
		this("SensorMotor", isInverted, motionController, motors);
	}

	public SensorMotor(SpeedModifier speedModifier, MotionController motionController, CustomSpeedController... motors) {
		this("SensorMotor", speedModifier, motionController, motors);
	}

	public SensorMotor(MotionController motionController, CustomSpeedController... motors) {
	...
	public void enableMotionController() {
		motionController.setOutput(this); //Waiting for fix from another group on motioncontroller setoutput method 
