...
/**
 * A SpeedModifier that does brownout protection
...
public class AccelerationCap implements SpeedModifier {
	 ...
	 *        This is used to monitor the battery
	 *        voltage.
	 * @param softStopVoltage
	 *        Voltage to stop increasing motor
	 *        speed at.
	 * @param hardStopVoltage
	 *        Voltage to begin decreasing motor
	 *        speed at.
	 */
	...
	/**
	 * Modify the input speed and get the new output.
	 * AccelerationCap does voltage ramping, which
	 * means that motor speed changes take place over
	 * 1/16th of a second rather than instantly.
	 * This decreases power consumption, but minimally
	 * affects performance.
	 *
	 * AccelerationCap also prevents brownouts by
	 * slowing motors as voltage decreases.
	 */
