 ...
 * A speed modifier changes the input
 * value of the motor. This class
 * should be used for fairly simple
...
public interface SpeedModifier {
	/**
	 * This function actually changes
	 * the speed that the motor should
	 * use.
	 * 
	 * @param speed
