...
/**
 * A class that wraps around a variable number of CustomSpeedController objects to give them Subsystem functionality.
...
public class Motor implements Subsystem, CustomSpeedController {
	 ...
	 * @param isInverted
	 *        Inverts the direction of all of the CustomSpeedControllers.
	 ...
	 * @param motors
	 *        The CustomSpeedControllers in this subsystem.
	 *        Can be a single CustomSpeedController or multiple CustomSpeedControllers.
	 */
	...
	/**
	 * Disables the motor.
	 * This function uses the underlying CustomSpeedController's disable implementation.
	 */
	@Override
	public void disable() {
		for (CustomSpeedController motor : motors) {
	...
	/**
	 * Stops the motor.
	 * This function uses the underlying CustomSpeedController's stopMotor implementation.
	 ...
	 * This respects the original inversion state of each CustomSpeedController when constructed,
	 * and will only invert CustomSpeedControllers if this.getInverted() != the input.
	 *
	 * @param isInverted
	 *        The state of inversion, true is inverted.
	 */
	...
	protected class StrangeCANSpeedControllerModeRuntimeException extends RuntimeException {
		...
		public StrangeCANSpeedControllerModeRuntimeException() {
			super("One of " + getName() + "'s CustomSpeedControllers is a CANSpeedController with a non-zero mode. This might mess up it's .get(), so Motor cannot verify safety.");
		}
	}
