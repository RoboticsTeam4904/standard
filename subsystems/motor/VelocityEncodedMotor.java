...
public class VelocityEncodedMotor extends VelocitySensorMotor {
	public VelocityEncodedMotor(String name, boolean isInverted, SpeedModifier speedModifier, MotionController motionController,
	...
	public VelocityEncodedMotor(String name, SpeedModifier speedModifier, MotionController motionController,
		SpeedController... motors) {
	...
	public VelocityEncodedMotor(boolean isInverted, SpeedModifier speedModifier, MotionController motionController,
		SpeedController... motors) {
