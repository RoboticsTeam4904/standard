...
public class PositionEncodedMotor extends PositionSensorMotor {
	public PositionEncodedMotor(String name, boolean isInverted, SpeedModifier speedModifier, MotionController motionController,
	...
	public PositionEncodedMotor(String name, SpeedModifier speedModifier, MotionController motionController,
		SpeedController... motors) {
	...
	public PositionEncodedMotor(boolean isInverted, SpeedModifier speedModifier, MotionController motionController,
		SpeedController... motors) {
