...
public class SimpleSplines extends SequentialCommandGroup {
  ...
  public static final DifferentialDriveVoltageConstraint autoVoltageConstraint = new DifferentialDriveVoltageConstraint(
      new SimpleMotorFeedforward(RobotMap.DriveConstants.ksVolts, RobotMap.DriveConstants.kvVoltSecondsPerMeter,
          RobotMap.DriveConstants.kaVoltSecondsSquaredPerMeter),
      RobotMap.DriveConstants.kDriveKinematics, 10);
  public static final TrajectoryConfig config = new TrajectoryConfig(RobotMap.AutoConstants.kMaxSpeedMetersPerSecond,
  ...
  public SimpleSplines(SensorDrive robotDrive, Pose2d init_pos, Pose2d final_pos, List inter_points) {
    super(new RamseteCommand(TrajectoryGenerator.generateTrajectory(init_pos, inter_points, final_pos, config),
        robotDrive::getPose,
        new RamseteController(RobotMap.AutoConstants.kRamseteB, RobotMap.AutoConstants.kRamseteZeta),
        new SimpleMotorFeedforward(RobotMap.DriveConstants.ksVolts, RobotMap.DriveConstants.kvVoltSecondsPerMeter,
            RobotMap.DriveConstants.kaVoltSecondsSquaredPerMeter),
        RobotMap.DriveConstants.kDriveKinematics, robotDrive::getWheelSpeeds,
